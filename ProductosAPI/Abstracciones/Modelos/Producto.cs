...
namespace Abstracciones.Modelos
{
        public class ProductoBase
        {
            ...
            [RegularExpression(@"^[^0|\D]\d{0,9}(\.\d{1,2})?$", ErrorMessage = "El nombre solo debe contener letras y ser decimal")]
            public decimal Precio { get; set; }
            [Required(ErrorMessage = "La propiedad stock es requerida")]
            [RegularExpression(@"^[0-9]+$", ErrorMessage = "El nombre solo debe contener letras y ser decimal")]
